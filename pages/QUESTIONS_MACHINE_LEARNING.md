...
## Which of the statements below about Hierarchical Agglomerative
...
- Vector space with real values -> ___
- Vectors of terms representing documents -> ___
- High dimensional spaces -> ___
- Boolean data -> ___
